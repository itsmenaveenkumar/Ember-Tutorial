...
exports.init = function(grunt, phantomjs) {
  ...
  var baseDir = '.',
      tempDir = 'build/client/.grunt/grunt-contrib-jasmine';
  ...
  exports.copyTempFile = function(src, buildOutdir, dest) {
    var file = path.join(tempDir,dest);
  ...
  exports.cleanTemp = function(cb) {
    rimraf(tempDir, function(){
      ...
      fs.rmdir('build/client/.grunt', cb);
    });
  };

  exports.buildSpecrunner = function (src, options){

    exports.copyTempFile(__dirname + '/../jasmine/reporters/PhantomReporter.js', options.buildOutdir, 'reporter.js');
    exports.copyTempFile(__dirname + '/../../vendor/jasmine-' + options.version + '/jasmine.css', options.buildOutdir, 'jasmine.css');
    exports.copyTempFile(__dirname + '/../../vendor/jasmine-' + options.version + '/jasmine.js', options.buildOutdir, 'jasmine.js');
    exports.copyTempFile(__dirname + '/../../vendor/jasmine-' + options.version + '/jasmine-html.js', options.buildOutdir, 'jasmine-html.js');
    exports.copyTempFile(__dirname + '/../jasmine/jasmine-helper.js', options.buildOutdir, 'jasmine-helper.js');
    exports.copyTempFile(__dirname + '/../helpers/phantom-polyfill.js', options.buildOutdir, 'phantom-polyfill.js');
    ...
    var source = '',
      outfile = options.buildOutdir + options.outfile,
